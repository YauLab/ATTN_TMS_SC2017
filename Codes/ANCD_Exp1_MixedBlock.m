...
%% Experiment 1, frequency discrimination, MIXED block: code for analysis

% Upload the mat file 'TMS_ATfreqXX_XXXX_MIXED.mat'
...
mean_acc_mixed_tactile=mean([(infoRP(infoRP(:,1)==1,10));(infoRP(infoRP(:,1)==2,10))]);
mean_acc_mixed_audio=mean([(infoRP(infoRP(:,1)==3,10));(infoRP(infoRP(:,1)==4,10))]);
